            ...
            <View style={styles.BottomView}>
                ...
                <Calendar
                  ...
                  />
                    ...
                    <TouchableOpacity style = {{flexDirection:'column',position:'absolute',top:15}} onPress={()=>{InsertData('텀블러',auth().currentUser.email,today)}}>
                         <Image 
