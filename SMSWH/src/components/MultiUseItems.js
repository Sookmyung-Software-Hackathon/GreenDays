...
const MultiUseItems = ({navigation})=>{
            ...
            <View style={styles.BottomView}>
                ...
                <Calendar
                  ...
                  />
                    ...
                    <TouchableOpacity style = {{flexDirection:'column',position:'absolute',top:15}}onPress={()=>{InsertData('다회용품',auth().currentUser.email,today)}}>
                        <Image 
