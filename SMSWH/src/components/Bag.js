            ...
            <View style={styles.BottomView}>
                ...
                <Calendar
                  ...
                  />
                    ...
                    <TouchableOpacity style = {{flexDirection:'column',position:'absolute',top:15}}onPress={()=>{InsertData('장바구니',auth().currentUser.email,today)}}>
                        <Image 
